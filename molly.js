window.imgDB = {
	...
	"burgerComplete": "./img/burger_eated.png",
};

window.startScene = "sloppy_molly_1";
...
"burger_gotted_opened": {
	...
	"opt1": {
		"text": "-->",
		"func": function() {
			window.open("./burger_game.html","_self")
		}
	}
},
"burger_gotted_finished": {
	"layer1": "seatedBG",
	"layer3": "table",
	"layer4": "burgerComplete",
	"text": "<i>Wow that was quite the burger!</i>",
	"opt1": {
		"text": "A melody of great flavours!",
		"func": "burger_gotted_opened"
	},
	"opt2": {
		"text": "I found it a tad out of tune...",
		"func": "burger_gotted_opened"
	},
	"opt3": {
